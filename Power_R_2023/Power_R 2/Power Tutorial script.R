...
# our sample size reduces significantly, going from 142 to 20!
# 3.3. How about our MDE?
# the MDE stayed the same!!! 
...
# The degrees of freedom for calculating the t-statistics will change as the sample size has changed. 
# This will slightly change our t-statistics 

t_power = qt(power, df=2*(total_clusters-1))
t_alpha = qt(1-alpha/2, df=2*(total_clusters-1))
